function newData = removeOGbias_Average(adaptData,OGtrials,OGbaseTrials)
% Made on 1/24/2017 to see if I just use the average OG behavior if I get
% different transfer results
%FORMERLY:
...
display('WARNING, USING THE WRONT OG BIAS, USE removeOGbias')
